    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (Education $education) {
                return '<a href="' . route("education", $education->id) . '" class="btn btn-md btn-primary text-white font-weight-bold"> Manage </a>';
            })
            ->addColumn('email', function (Education $education){
                return $education->user->email ?? '';
            })
            ->addColumn('created_at', function (Education $education){
                return date('Y-m-d H:i:sa', strtotime($education->created_at));
            })
            ...
            ->addColumn('status', function (Education $education){
                return status($education->status);
            })
